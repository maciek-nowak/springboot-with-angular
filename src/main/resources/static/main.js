...
module.exports = "<h1>Server component</h1>\n<p>Server with id {{id}} is {{status}}</p>\n"
...
module.exports = "<p>\n  servers works!\n</p>\n<input\n  type=\"text\"\n  class=\"form-control\"\n  (input)=\"onUpdateServerName($event)\"\n>\n<p>New server name is {{serverName}}</p>\n<button type=\"button\" (click)=\"resetNewServername()\">Reset new server name</button>\n<button [disabled]=\"!allowNewServers\" (click)=\"onServerCreation()\">Add server</button>\n<p>{{serverCreationStatus}}</p>\n<app-server></app-server>\n<app-server></app-server>\n"
...
var ServersComponent = /** @class */ (function () {
    ...
    ServersComponent.prototype.onServerCreation = function () {
        this.serverCreationStatus = 'Server created';
    };
    ServersComponent.prototype.onUpdateServerName = function (event) {
        this.serverName = event.target.value;
    };
    ServersComponent.prototype.resetNewServername = function () {
        var _this = this;
...
module.exports = __webpack_require__(/*! /home/maciej/codecool/SAMSUNG/angular-test-app/src/main.ts */"./src/main.ts");
